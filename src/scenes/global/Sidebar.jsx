...
const Sidebar = () => {
  ...
  return (
    <Box
      sx={{
        "& .pro-sidebar-inner": {
          background: `${colors.rosa[200]} !important`,
        },
        "& .pro-icon-wrapper": {
      ...
      <ProSidebar collapsed={isCollapsed}>
        <Menu iconShape="square">
          ...
          {!isCollapsed && (
             <Box mb="25px">  
                ...
                <Box textAlign="center">
                    <Typography variant="h2" color={colors.grey[100]} fontWeight="bold" sx={{m:"10px 0 0 0"}}>Jenyffer</Typography>
                    <Typography variant="h5" color={colors.grey[500]} fontWeight="bold" sx={{m:"10px 0 0 0"}}>CEO</Typography>
                </Box>
             </Box>
          )}
          {/* MENU ITENS */}
          <Box paddingLeft={isCollapsed? undefined : "10%"}>
            ...
            <Typography variant="h6" color={colors.grey[300]} sx={{m: "15px 0 5px 20px"}}>Dados</Typography>
